...
def download_images(link_file_images, output_directory, image_type):
    ...
    for image_link in tqdm(image_links, total = len(image_links)):
        ...
        image_path = output_directory + image_type + "/" + os.path.basename(image_link.rstrip('\n'))
...
if __name__ == '__main__':
    ...
    link_file_images = "../Data/_Links/{}/Images_n50.txt".format(dataset_name)
    link_file_targets = "../Data/_Links/{}/Targets_n50.txt".format(dataset_name)
    output_directory = "../Data/{}_n50/".format(dataset_name)
